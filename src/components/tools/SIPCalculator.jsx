...
const SIPCalculator = () => {
    ...
    useEffect(() => {
        setResult(calculateSIP(monthlyInvestment, rate, years));
    ...
    return (
        <CalculatorLayout
            ...
            formula={
                <div>
                    <p>M = Monthly investment</p>
                    <p>r = Annual return / 12 / 100</p>
                    <p>n = Years × 12</p>
                    <p><strong>Future Value = M × [((1 + r)^n − 1) / r] × (1 + r)</strong></p>
                </div>
            }
        >
            <div style={{ display: 'flex', flexDirection: 'column', gap: '1.5rem' }}>
                {/* Monthly Investment */}
                <div>
                    <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>Monthly Investment</label>
                ...
                {/* Expected Return */}
                <div>
                    <label style={{ display: 'block', marginBottom: '0.5rem', fontWeight: '500' }}>Expected Return (p.a) %</label>
                    <div className="input-with-icon">
